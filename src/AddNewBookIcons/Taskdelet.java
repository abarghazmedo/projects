 ...
 * @author Ibtissam 
 */
public class Taskdelet extends javax.swing.JFrame {
   ...
   //to set task table 
    ...
    public void setTaskToTable() {
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT t.taskID,t.TaskName,t.TaskDescription,u.UserName "
                    + ",p.ProjectName ,t.TaskPriority,t.TaskStatut,t.TaskType FROM task t "
            ...
            while (rs.next()) {
                ...
                String prioritytask = rs.getString(6);
                String statuttask = rs.getString(7);
                String typetask = rs.getString(8);// Assuming the description is in the third column


                Object[] obj = {idtask,nametask,descriptiontask,assinetotask,projecttask ,prioritytask,statuttask, typetask};
    ...
    public boolean addTask() {
       ...
       // idTask = Integer.parseInt(txt_idtask.getText());
        ...
        try {
            ...
            String sql = "insert into task (TaskName ,TaskDescription , userID  , projectID , TaskPriority , TaskStatut ,TaskType) value(?,?,?,?,?,?,?)";
            PreparedStatement prs = con.prepareStatement(sql);
            HashMap<String,Integer> map=mq.PopulateCombousers();
            HashMap<String,Integer> mapP=mq.PopulateComboprojet();
            ...
            prs.setString(5, priorityTask);
            prs.setString(6, statutTask);
            prs.setString(7, typeTask);
    ...
    public boolean updateTask(int id) {
      ...
      //  idTask = Integer.parseInt(txt_idtask.getText());
        ...
        try {
            Connection con = DBconnection.getConnection();
            String sql = "UPDATE task SET TaskName=?,TaskDescription=?, userID=?, projectID=?, TaskPriority=?, TaskStatut=?, TaskType=? WHERE taskID="+id+";";
            PreparedStatement prs = con.prepareStatement(sql);
  ...
  //clear table 
    ...
    private void initComponents() {
        ...
        txt_nametask = new javax.swing.JTextField();
        ...
        tbl_task.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Task Id", "Name Task", "Description", "Assine To", "Project", "Priority", "Statut", "Type"
            }
        ));
        ...
        txt_nametask.setFont(new java.awt.Font("Bahnschrift", 0, 14)); // NOI18N
        txt_nametask.setForeground(new java.awt.Color(0, 81, 98));
        txt_nametask.setActionCommand("<Not Set>");
        txt_nametask.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 81, 98)));
        txt_nametask.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_nametaskActionPerformed(evt);
            }
        });
        jPanel16.add(txt_nametask, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 230, 30));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(0, 81, 98));
        jLabel13.setText("Name task");
        jPanel16.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 90, 20));
        ...
        jPanel16.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 230, 100));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 81, 98));
        jLabel17.setText("Description");
        jPanel16.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 90, 20));
        ...
        jPanel16.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 70, 20));
        ...
        jPanel16.add(cmbpriority, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 230, 30));

        jLabel24.setBackground(new java.awt.Color(255, 255, 255));
        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(0, 81, 98));
        jLabel24.setText("Priority");
        jPanel16.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 110, 70, 20));
        ...
        jPanel16.add(cmbstatut, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 160, 230, 30));

        jLabel23.setBackground(new java.awt.Color(255, 255, 255));
        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(0, 81, 98));
        jLabel23.setText("Statut");
        jPanel16.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 170, 70, 20));
        ...
        jPanel16.add(cmbtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 210, 230, 30));
        ...
        jPanel16.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 190, 130, 40));
        ...
        jPanel16.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 120, 130, 40));
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
       Projectol project=new Projectol();
    ...
    private void txt_nametaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_nametaskActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nametaskActionPerformed
    ...
    private void tbl_taskMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_taskMouseClicked
      ...
      //  txt_idtask.setText(model.getValueAt(rowN, 0).toString());
        ...
        cmbpriority.setSelectedItem(model.getValueAt(rowN, 5).toString());
        cmbstatut.setSelectedItem(model.getValueAt(rowN, 6).toString());       
        cmbtype.setSelectedItem(model.getValueAt(rowN, 7).toString());
   ...
   // public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Taskdelet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txt_nametask;
