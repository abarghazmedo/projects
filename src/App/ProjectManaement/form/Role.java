...
public class Role extends javax.swing.JFrame {
    ...
    public boolean addRole() {
       ...
       // id_Role = Integer.parseInt(txt_idRole.getText());
        ...
        try {
            Connection con = DBconnection.getConnection();
            String sql = "insert into role (NameRole)value(?)";
    ...
    public boolean updateRole(int id) {
      ...
      //  id_Role= Integer.parseInt(txt_idRole.getText());
        ...
        try {
            Connection con = DBconnection.getConnection();
            String sql = "UPDATE role SET NameRole=? WHERE RoleID="+id+";";
            PreparedStatement prs = con.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jPanel15.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 860, 240));

        jLabel11.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 81, 98));
        jLabel11.setText("Role Management");
        jLabel11.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 3, 0, new java.awt.Color(0, 81, 98)));
        jPanel15.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 20, -1, -1));
        ...
        jLabel13.setText("Role Name");
        jPanel12.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 90, 20));
        ...
        jPanel12.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 30, 130, -1));
        ...
        jPanel12.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 100, 130, -1));
        ...
        jPanel12.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 170, 130, -1));
        ...
        jPanel12.add(txt_nameRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, 230, -1));

        jPanel15.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 910, 230));

        jPanel11.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(-110, 0, 970, 570));

        jPanel10.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 860, 570));
