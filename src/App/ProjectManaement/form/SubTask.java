...
import static App.ProjectManaement.form.Task.idTask;
...
public class SubTask extends javax.swing.JFrame {
   ...
   //to set subtask table 
    
   public void setsubTaskToTable() {
    try (Connection con = DBconnection.getConnection();
         PreparedStatement st = con.prepareStatement("SELECT s.subtaskID, s.subTaskName, s.subTaskDescription, u.UserName, t.TaskName, s.EstimersubTask, s.subTaskPriority, s.subTaskStatut, s.subTaskType FROM subtask s, userproject u, task t WHERE u.UserID = s.UserID AND t.taskID = s.taskID");
         ResultSet rs = st.executeQuery()) {

        while (rs.next()) {
            int idsubtask = rs.getInt(1);
            String namesubtask = rs.getString(2);
            String descriptionsubtask = rs.getString(3);
            String assinetosubtask = rs.getString(4);
            String tasksubtask = rs.getString(5);
            int Estimersubtask = rs.getInt(6);
            String prioritysubtask = rs.getString(7);
            String statutsubtask = rs.getString(8);
            String typesubtask = rs.getString(9);
    ...
    public boolean addsubTask() {
       ...
       // idTask = Integer.parseInt(txt_idtask.getText());
        ...
        try {
            ...
            String sql = "INSERT INTO `subtask`( subtaskName , subtaskDescription, `userID`,`taskID`, EstimersubTask, subtaskPriority, subtaskStatut, subtaskType) VALUES (?,?,?,?,?,?,?,?)";
   ...
   public boolean updateSubTask(int id) {
    ...
    try {
        Connection con = DBconnection.getConnection();
        String sql = "UPDATE subtask SET subTaskName=?, subTaskDescription=?, userID=?, taskID=?, EstimersubTask=?, subTaskPriority=?, subTaskStatut=?, subTaskType=? WHERE subtaskID=?";
        PreparedStatement prs = con.prepareStatement(sql);
  ...
  //clear table 
    ...
    private void initComponents() {
        ...
        jPanel14.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 150, -1));
        ...
        jPanel12.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 150, -1));
        ...
        tbl_subtask.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SubTask Id", "Name ", "Description", "Assine To", "Task", "Estimer", "Priority", "Statut", "Type"
            }
        ));
        ...
        jPanel16.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 230, 100));

        jLabel17.setBackground(new java.awt.Color(255, 255, 255));
        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 81, 98));
        jLabel17.setText("Description");
        jPanel16.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 100, 20));
        ...
        jPanel16.add(cmbtask, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, 230, 30));

        jLabel22.setBackground(new java.awt.Color(255, 255, 255));
        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(0, 81, 98));
        jLabel22.setText("Hour");
        jPanel16.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 100, 50, 20));
        ...
        jPanel16.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 150, 70, 20));
        ...
        jPanel16.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 190, 70, 20));
        ...
        jPanel16.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, 70, 20));
        ...
        jPanel16.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 60, 70, 20));

        jLabel27.setBackground(new java.awt.Color(255, 255, 255));
        jLabel27.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(0, 81, 98));
        jLabel27.setText("Estimer");
        jPanel16.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 70, 20));
        ...
        jLabel11.setText("Sub Task Management");
